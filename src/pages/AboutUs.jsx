    ...
    return(
        <>
            ...
            <section className="mb-15 sm:mb-30 px-4 sm:px-6">
                <p className="mb-4">Børnelejren på Langeland er en velgørende, non-profit forening, som afholder
                ...
                <p className="mb-4">Foreningens bestyrelse og frivillige hjælpere arbejder ulønnet for Foreningen.
                Medarbejderne fra institutionerne på foreningens lejre, får ikke kolonitillæg udbetalt af
                Foreningen.</p>

                <p className="mb-4">Det er primært virksomheder og støttemedlemmer, der finansierer foreningens drift og
